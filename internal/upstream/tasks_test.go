...
func TestTaskGetMalformedFixtures(t *testing.T) {
	...
	cases := []struct {
		...
		{"invalid created timestamp", `{"resultType":"complete","taskId":"` + taskID + `","status":"working","createdAt":"yesterday","lastUpdatedAt":"2026-09-11T10:00:01Z","ttlMs":86400000,"pollIntervalMs":1000}`},
